                ...
                child: ListView(
                  children:<Widget> [
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.all(2.0),
                            child: CircleAvatar(backgroundImage: AssetImage("assets/images/p2.jpg"),),   // image 2
                          ),
                          Padding(
                            padding: const EdgeInsets.all(2.0),
                            child: CircleAvatar(backgroundImage: AssetImage("assets/images/p3.jpg"),),  //image 3
                          ),
                          Padding(
                            padding: const EdgeInsets.all(2.0),
                            child: CircleAvatar(backgroundImage: AssetImage("assets/images/p1.jpg"),),   //image 1
                          ),
                        ],
                      ),
                    ),
                    ...
                    ListTile(
                      ...
                      leading: CircleAvatar(backgroundImage: AssetImage("assets/images/p3.jpg"),),   //image 3
                    ...
                    ListTile(
                      ...
                      leading: CircleAvatar(backgroundImage: AssetImage("assets/images/p2.jpg"),),   // image 2
                      title: RichText(text: TextSpan(children: [
        ...
        bottomNavigationBar: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Dashboard", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600),),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Beneficiaries", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: grey),),
              ),
