...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
              ...
              children:<Widget> [
                Row(
                  ...
                  Container(
                    child: Row(
                      children: <Widget> [
                        Icon(Icons.notifications, color: Colors.red[100],),
                        SizedBox(width: 16,),
                        CircleAvatar(
                          radius: 25,
                          ...
                          child: ClipOval(
                            child: Image.asset(
                              "assets/images/user.png", fit: BoxFit.contain,
                    ...
                    Container(
                      child: Column(
                        children:  <Widget> [
                          ...
                          Text("Send", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.red[100]),),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Column(
                        children:  <Widget> [
                          ...
                          Text("Request", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.red[100]),),
                    ...
                    Container(
                      child: Column(
                        children:  <Widget> [
                          ...
                          Text("Loan", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.red[100]),),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      child: Column(
                        children:  <Widget> [
                          ...
                          Text("Topup", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.red[100]),),
                        ],
                      ),
                    )
      ...
      // Container for ListView for Expenses and Incomes
                            Container(
                              child: Text("TODAY", style: TextStyle(fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                              padding: EdgeInsets.symmetric(horizontal: 32),
                            ),
      ...
      // Now Expense
                            Container(
                              child: Text("YESTERDAY", style: TextStyle(fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                              padding: EdgeInsets.symmetric(horizontal: 32),
                            ),
                                  ...
                                  child: Row(
                                    children:<Widget> [
                                      ...
                                      Column(
                                        crossAxisAlignment : CrossAxisAlignment.end,
                                        children: <Widget> [
                                          Text("\$200.5", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.orange),),
                                          Text("25 Jan", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.grey[500]),),
                                        ],
                                      ),
                                    ],
                                  ),
